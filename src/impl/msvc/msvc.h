...
patomic_impl_create_msvc(size_t, patomic_memory_order_t, unsigned int);

PATOMIC_NO_EXPORT patomic_explicit_t
patomic_impl_create_explicit_msvc(size_t, unsigned int);

PATOMIC_NO_EXPORT patomic_transaction_t
patomic_impl_create_transaction_msvc(unsigned int);
